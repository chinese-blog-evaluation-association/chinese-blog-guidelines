...
> [!NOTE]
> 点击每行开头的数字标号查看各项的详细说明，以及浏览对应示例

[1](./doc/cbgb001.md). 自动播放多媒体资源。  
[2](./doc/cbgb002.md). 动态页面标题。  
[3](./doc/cbgb003.md). 页面加载时弹出提示框限制用户操作。  
[4](./doc/cbgb004.md). 过多的特效。  
[5](./doc/cbgb005.md). 检测到广告过滤程序后影响用户浏览内容。  
